...
# Description: PPP PRIVATE NETWORK UDP/IP AGGLIGATOR LINUX BUILD SCRIPT CROSS.(X) 1.0.0 VERSION.
# Author     : Kyou.
...
PPP_build() {
    ...
    ARTIFACT_NAME=aggligator-linux-$PLATFORM.zip
    rm -rf $ARTIFACT_NAME
    zip -r $ARTIFACT_NAME aggligator
