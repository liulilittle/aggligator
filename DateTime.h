...
namespace aggligator {
    ...
    public:
        std::string             ToString(const char* format) noexcept { return ToString(format, true); }
        std::string             ToString(const char* format, bool fixed) noexcept;
